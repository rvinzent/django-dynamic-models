...
class ModelSchemaEditor:
    def __init__(self, initial_model=None, db_name=DEFAULT_DB_ALIAS, is_managed=True):
...
class FieldSchemaEditor:
    def __init__(self, initial_field=None, db_name=DEFAULT_DB_ALIAS, is_managed=True):
